...
A typed client for the **native** QPost API (`/qp/v3`), generated from the OpenAPI spec vendored at
[`npm/openapi/qpost-v3-openapi.yaml`](./npm/openapi/qpost-v3-openapi.yaml) (synced from the QPost API
repo). See [`npm/README.md`](./npm/README.md) for install, usage, error handling, and type
regeneration.
